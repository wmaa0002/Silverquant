# 克隆自聚宽文章：https://www.joinquant.com/post/63107
# 标题：一年多整体效果还可以，盈利能力强，实盘测试
# 作者：俺也一样0
...
def initialize(context):
    ...
    g.target_list = []
    g.pass_months = [1, 4]  # 空仓的月份（已失效，仅作保留）
    ...
    g.money_etf = '511880.XSHG'  # 空仓月份持有银华日利ETF（仅作保留）
    # 设置交易运行时间
